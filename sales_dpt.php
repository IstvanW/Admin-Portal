...
$sql="SELECT url from link where department = 3";
$db->query($sql);
$result = $db->resultSet();
?>
    ...
    <body>
        ...
        <div class="container">  
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-4">
                    <a href="<?php echo $result[1]->url; ?>" class="tile blue">
                        <img class="card-img-top center-block" src="icons/users.svg" alt="Card image cap">
                        <div class="card-body">
                            <h3 class="title">Sales Leads</h3>
                            <p>Contact information for potential clients.</p>
                        </div>
                    </a>
                </div>
                
                <div class="col-sm-4">
                <a href="<?php echo $result[2]->url; ?>" class="tile blue">
                    <img class="card-img-top center-block" src="icons/briefcase.svg" alt="Card image cap">
                    <div class="card-body">
                        <h3 class="title">Sales Demo</h3>
                        <p>Presentation tools for client demos.</p>
                    </div>
                </a>
                </div>
